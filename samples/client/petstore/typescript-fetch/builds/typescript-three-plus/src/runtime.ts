 ...
 */
export function serializeArrayObjectsToFormData(formData: FormData | URLSearchParams, paramName: string, arr: any[]) {
    arr.forEach(elem => {
 ...
 */
export function appendFormData(formData: FormData, data: unknown, previousKey?: string) {
